...
import {
  HeaderCSAlertsStyled,
  HeaderCSImgStyled, HeaderCSMenuStyled,
  HeaderCSMessagesStyled,
  HeaderCSStyled
} from "./HeaderControllsSettingsStyles";

export const HeaderControllsSettings: FC = () => {
  return (
    <HeaderCSStyled>
      <HeaderCSMenuStyled>
        <svg fill="#E4E6EB" viewBox="0 0 44 44" width="20" height="20">
      ...
      <HeaderCSMessagesStyled>
        <svg viewBox="0 0 28 28" fill="#E4E6EB"
             height="20" width="20">
          <path
